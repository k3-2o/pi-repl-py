...
export function buildPromptGuidelines(): string[] {
	return [
		...
		"REPL-driven development: the live session's namespace is the single source of truth; reuse and extend existing objects rather than redefining or recomputing them.",
